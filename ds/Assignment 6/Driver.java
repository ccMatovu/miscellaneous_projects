...
*/
      ...
      System.out.println();
		...
		myList.moveToEnd();
		System.out.println("\nMove 92 to the end and now the list contains the " + numberOfEntries +
				" entries, as follows:");
		for (int position = 1; position <= numberOfEntries; position++)
			System.out.println(myList.getEntry(position) +
					" is entry " + position);
		...
		myList.moveToEnd();
		System.out.println("\nMove 93 to the end and now the list contains the " + numberOfEntries +
				" entries, as follows:");
		for (int position = 1; position <= numberOfEntries; position++)
			System.out.println(myList.getEntry(position) +
					" is entry " + position);
		...
		myList.moveToEnd();
		System.out.println("\nMove 52 to the end and now the list contains the " + numberOfEntries +
				" entries, as follows:");
		for (int position = 1; position <= numberOfEntries; position++)
			System.out.println(myList.getEntry(position) +
					" is entry " + position);
