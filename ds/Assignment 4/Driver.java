...
public class Driver 
{
	...
	public static void testQueueOperations()
	{
		...
		System.out.println("Add to queue to " +
				"" +
				"get\n" +
		...
		System.out.println("Create another queue and add Jill, Jane, Jerry \n");
		QueueInterface<String> myQueue2 = new LinkedQueue<>();
		myQueue2.enqueue("Jill");
		myQueue2.enqueue("Jane");
		myQueue2.enqueue("Jerry");

		String front = myQueue.getFront();
		System.out.println(front + " is at the front of the queue (the first one).");

		front = myQueue2.getFront();
		System.out.println(front + " is at the front of the second queue.\n");

		System.out.println("Splice the second queue to the first queue \n");
		myQueue.splice(myQueue2);
